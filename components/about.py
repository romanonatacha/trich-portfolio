                    ...
                    html.Div(
                        [
                            dbc.Row(
                                ...
                                On trich.ai we have already built solutions for some of the biggest companies around the world, building creative and profitable results to our clients. We mainly focus on open-source solutions.",
                                                    html.Br(),
                                                    html.Br(),
                                            ...
                                            dbc.Row(
                                                [
                                                    dbc.Col(
                                                        [
                                                            html.I(
                                                                className="fab fa-github padding16"
                                                            ),
                                                            html.Span("+"),
                                                            html.I(
                                                                className="fab fa-kaggle padding16"
                                                            ),
                                                        ],
                                                        width=12,
                                                        className="font-lg",
